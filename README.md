...
![CommerceKit v3](https://raw.githubusercontent.com/jeffersongoncalves/commercekitv3/main/art/jeffersongoncalves-commercekitv3.png)

</div>

# CommerceKit v3

A headless-commerce back office, ready to run — a Laravel 12 + Filament v3 starter application with a
...
CommerceKit v3 follows the FilaKit multi-panel pattern: three Filament panels backed by two
